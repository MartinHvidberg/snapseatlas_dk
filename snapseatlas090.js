...
var sa_build = "20230405.1508/next"
var sa_nickname = "postPaaske_Lolland"
console.log("Start:", sa_name, "ver.", sa_ver, sa_nickname, sa_build);

// *** Set up the base map

	var inicenter = [55.00, 11.33]; // [54.81, 11.33];
	var inizoom = 10; // larger is closer
...
// *** Setup some plants layers ...
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Prunus spinosa';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Myrica gale';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Juniperus';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Galium odoratum';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Angelica';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Seriphidium';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Achillea';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Galium verum';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Hypericum';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Tanacetum';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Juglans';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Vaccinium';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Rubus';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Calluna';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Potentilla erecta';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Empetrum nigrum';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Hippopha';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Corylus';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Thymus';
	...
	var urlbbox = 'php090/data.php?bbox='+bbox+'&species=Rosa';
...
function newOccurence (e) {
	...
	var lurl = 'php090/NewOccurrenceForm.php?lat='+llat+'&lon='+llng;
	//alert(lurl);
